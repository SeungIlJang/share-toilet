...
배포용 앱은 AAB에 포함된 웹 화면을 기본으로 실행하고, GitHub Pages의 `live-update/manifest.json`을 확인해 새 웹 번들을 내려받습니다.

- `main` 브랜치에 푸시하면 GitHub Actions가 내용 해시가 달라진 웹 번들을 생성해 GitHub Pages에 배포합니다.
